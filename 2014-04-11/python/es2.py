#Visione in 3D completa che produce il modello unico
from pyplasm import *
...
VIEW((SKELETON(1)(STRUCT([portaColorata,tettoPunta,plinti,colonne,baseGiustaColorata]))))
VIEW((STRUCT([portaColorata,tettoPunta,plinti,colonne,baseGiustaColorata])))
