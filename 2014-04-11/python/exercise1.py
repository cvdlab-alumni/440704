#Visione in 3D con SKELETON, base e scalini pieni; colonne, plinti, altra base, tetto, porta e struttura interna con skeleton
from pyplasm import *
...
portaColorata = (COLOR([0.80,0.52,0.24]))(SKELETON(1)(STRUCT([porta])))
...
VIEW((STRUCT([base,tettoPunta,scalini,plinti,colonne,baseIntornoVeraColorata])))
